...
// 添加菜单
#[web::post("/menu_save")]
pub async fn menu_save(item: Json<MenuSaveReq>) -> Result<impl web::Responder, web::Error> {
...
pub async fn menu_update(item: Json<MenuUpdateReq>) -> Result<impl web::Responder, web::Error> {
