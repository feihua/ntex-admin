...
pub async fn role_save(
    item: web::types::Json<RoleSaveReq>,
...
pub async fn role_delete(
    item: web::types::Json<RoleDeleteReq>,
) -> Result<impl web::Responder, web::Error> {
...
pub async fn role_update(
    item: web::types::Json<RoleUpdateReq>,
) -> Result<impl web::Responder, web::Error> {
...
pub async fn role_list(
    item: web::types::Json<RoleListReq>,
) -> Result<impl web::Responder, web::Error> {
    ...
    match &mut RB.clone().get() {
        Ok(conn) => {
            ...
            Ok(BaseResponse::<Vec<RoleListData>>::ok_result_page(list, 10))
        }
        Err(err) => {
            error!("err:{}", err.to_string());
            Ok(BaseResponse::<String>::err_result_msg(err.to_string()))
...
pub async fn query_role_menu(
    item: web::types::Json<QueryRoleMenuReq>,
) -> Result<impl web::Responder, web::Error> {
...
pub async fn update_role_menu(
    item: web::types::Json<UpdateRoleMenuReq>,
) -> Result<impl web::Responder, web::Error> {
