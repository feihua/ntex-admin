...
pub async fn role_update(item: Json<RoleUpdateReq>, data: State<AppState>) -> Result<impl Responder, Error> {
...
pub async fn query_role_menu(item: Json<QueryRoleMenuReq>, data: State<AppState>) -> Result<impl Responder, Error> {
...
pub async fn update_role_menu(item: Json<UpdateRoleMenuReq>, data: State<AppState>) -> Result<impl Responder, Error> {
