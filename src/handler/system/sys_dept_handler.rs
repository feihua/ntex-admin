...
pub async fn add_sys_dept(item: Json<AddDeptReq>) -> impl web::Responder {
...
pub async fn delete_sys_dept(item: Json<DeleteDeptReq>) -> impl web::Responder {
...
pub async fn update_sys_dept(item: Json<UpdateDeptReq>) -> impl web::Responder {
...
pub async fn update_sys_dept_status(item: Json<UpdateDeptStatusReq>) -> impl web::Responder {
...
pub async fn query_sys_dept_detail(item: Json<QueryDeptDetailReq>) -> impl web::Responder {
...
pub async fn query_sys_dept_list(item: Json<QueryDeptListReq>) -> impl web::Responder {
