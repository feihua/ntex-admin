...
pub async fn add_sys_dict_data(item: Json<AddDictDataReq>) -> impl web::Responder {
...
pub async fn delete_sys_dict_data(item: Json<DeleteDictDataReq>) -> impl web::Responder {
    info!("delete sys_dict_data params: {:?}", &item);
    let rb = &mut RB.clone();

    let result = DictData::delete_by_map(rb, value! {"dict_code": &item.ids}).await;
...
pub async fn update_sys_dict_data(item: Json<UpdateDictDataReq>) -> impl web::Responder {
    ...
    let result = DictData::update_by_map(rb, &sys_dict_data, value! {"dict_code": &req.dict_code}).await;
...
pub async fn update_sys_dict_data_status(item: Json<UpdateDictDataStatusReq>) -> impl web::Responder {
...
pub async fn query_sys_dict_data_detail(item: Json<QueryDictDataDetailReq>) -> impl web::Responder {
...
pub async fn query_sys_dict_data_list(item: Json<QueryDictDataListReq>) -> impl web::Responder {
