...
pub async fn add_sys_dict_type(item: Json<AddDictTypeReq>) -> AppResult<Response> {
...
pub async fn update_sys_dict_type(item: Json<UpdateDictTypeReq>) -> AppResult<Response> {
