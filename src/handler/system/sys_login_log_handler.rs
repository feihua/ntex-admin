...
pub async fn delete_sys_login_log(item: Json<DeleteLoginLogReq>) -> impl web::Responder {
...
pub async fn clean_sys_login_log(item: Json<DeleteLoginLogReq>) -> impl web::Responder {
...
pub async fn query_sys_login_log_detail(item: Json<QueryLoginLogDetailReq>) -> impl web::Responder {
...
pub async fn query_sys_login_log_list(item: Json<QueryLoginLogListReq>) -> impl web::Responder {
