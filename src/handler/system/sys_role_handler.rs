...
pub async fn add_sys_role(item: Json<RoleReq>) -> AppResult<Response> {
...
pub async fn delete_sys_role(item: Json<DeleteRoleReq>) -> AppResult<Response> {
...
pub async fn update_sys_role(item: Json<RoleReq>) -> AppResult<Response> {
...
pub async fn update_sys_role_status(item: Json<UpdateRoleStatusReq>) -> AppResult<Response> {
...
pub async fn query_sys_role_detail(item: Json<QueryRoleDetailReq>) -> AppResult<Response> {
...
pub async fn query_sys_role_list(item: Json<QueryRoleListReq>) -> AppResult<Response> {
    ...
    let mut sys_role_list_data: Vec<RoleResp> = Vec::new();
    for x in d.records {
        sys_role_list_data.push(x.into())
    }
...
pub async fn query_role_menu(item: Json<QueryRoleMenuReq>) -> AppResult<Response> {
...
pub async fn update_role_menu(item: Json<UpdateRoleMenuReq>) -> AppResult<Response> {
 ...
 *date：2025/01/10 09:21:35
 */
#[web::post("/role/queryAllocatedList")]
pub async fn query_allocated_list(item: Json<AllocatedListReq>) -> AppResult<Response> {
    info!("update role_menu params: {:?}", &item);
 ...
 *date：2025/01/10 09:21:35
 */
#[web::post("/role/queryUnallocatedList")]
pub async fn query_unallocated_list(item: Json<UnallocatedListReq>) -> AppResult<Response> {
    info!("update role_menu params: {:?}", &item);
 ...
 *date：2025/01/10 09:21:35
 */
#[web::post("/role/cancelAuthUser")]
pub async fn cancel_auth_user(item: Json<CancelAuthUserReq>) -> AppResult<Response> {
    info!("update role_menu params: {:?}", &item);
 ...
 *date：2025/01/10 09:21:35
 */
#[web::post("/role/batchCancelAuthUser")]
pub async fn batch_cancel_auth_user(item: Json<CancelAuthUserAllReq>) -> AppResult<Response> {
 ...
 *date：2025/01/10 09:21:35
 */
#[web::post("/role/batchAuthUser")]
pub async fn batch_auth_user(item: Json<SelectAuthUserAllReq>) -> AppResult<Response> {
