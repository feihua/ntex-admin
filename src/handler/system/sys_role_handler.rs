...
pub async fn add_sys_role(item: Json<AddRoleReq>) -> impl web::Responder {
...
pub async fn delete_sys_role(item: Json<DeleteRoleReq>) -> impl web::Responder {
...
pub async fn update_sys_role(item: Json<UpdateRoleReq>) -> impl web::Responder {
...
pub async fn update_sys_role_status(item: Json<UpdateRoleStatusReq>) -> impl web::Responder {
...
pub async fn query_sys_role_detail(item: Json<QueryRoleDetailReq>) -> impl web::Responder {
...
pub async fn query_sys_role_list(item: Json<QueryRoleListReq>) -> impl web::Responder {
...
pub async fn query_role_menu(item: Json<QueryRoleMenuReq>) -> impl web::Responder {
...
pub async fn update_role_menu(item: Json<UpdateRoleMenuReq>) -> impl web::Responder {
...
pub async fn query_allocated_list(item: Json<AllocatedListReq>) -> impl web::Responder {
    info!("update role_menu params: {:?}", &item);
...
pub async fn query_unallocated_list(item: Json<UnallocatedListReq>) -> impl web::Responder {
    info!("update role_menu params: {:?}", &item);
...
pub async fn cancel_auth_user(item: Json<CancelAuthUserReq>) -> impl web::Responder {
    info!("update role_menu params: {:?}", &item);
...
pub async fn batch_cancel_auth_user(item: Json<CancelAuthUserAllReq>) -> impl web::Responder {
...
pub async fn batch_auth_user(item: Json<SelectAuthUserAllReq>) -> impl web::Responder {
